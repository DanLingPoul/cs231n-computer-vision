...
class CaptioningSolver(object):
  ...
  """
    ...
    """
        ...
        self.batch_size=kwargs.pop('lr_decay',100)
        self.num_epochs=kwargs.pop('num_epochs',10)
        self.print_every=kwargs.pop('print_every',10)
        self.verbose=kwargs.pop('verbose',True)
        
        #Throw  an error if there are extra keyword argments
        if len(kwargs)>0:
    ...
    def _reset(self):
        ...
        self.val_acc_hisory=[]
        #Make a deep copy of the optim_config for each paramter
        self.optim_configs={}
