...
def batchnorm_forward(x,gamma,beta,bn_param):
    ...
    During ttraining we also keep an exponentially decaying runing mean of the mean and
    variance of each feature,and these averages are used to normalize data at test-time
  ...
  of batch normalization also uses running averages.
   ...
   -bn_param: Dictionary with the following keys:
     ...
     -running_var: Array of shape (D,) giving running mean of features
    ...
    if mode=='train':
        ...
        cache=(x,gemma,beta,x_hat,sample_mean,sample_var,eps)
    ...
    #Store the undated running means back into bn_param
...
def dropout_forward(x,dropout_param):
    """
    Perform the forward pass for (inverted) dropout.
    Inputs:
  ...
  """
        ...
        for i in range(out_height):
            for j in range(out_width):
                ...
                #flags:only the max value is True,others are Flase
